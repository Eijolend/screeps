...
module.exports = {
    start : function(rallyFlag,targetFlag){
        ...
        Game.rooms['W61N68'].requestCreep(healBody,undefined,{role : 'planOutheal', num : 0 });
        Game.rooms['W61N68'].requestCreep(healBody,undefined,{role : 'planOutheal', num : 1 });
        Game.rooms['W61N68'].requestCreep(healBody,undefined,{role : 'planOutheal', num : 2 });
        ...
        Game.rooms['W61N68'].requestCreep(
            ...
            'Desmond',{role : 'planOutheal', subrole : 'dismantler' }
        );
        ...
        Game.rooms['W61N68'].requestCreep(disBody,undefined,{role : 'planOutheal', subrole : 'dismantler' });
        Game.rooms['W61N68'].requestCreep(disBody,undefined,{role : 'planOutheal', subrole : 'dismantler' });
